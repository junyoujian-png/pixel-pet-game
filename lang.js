...
const LANG_DATA = {
  'zh-TW': {
    ...
    'focus.penalty': '像素晶石 -100',
    'focus.home': '返回首頁',
    'focus.restart': '重新開始',
    'focus.sound': '背景音效',
    'focus.sound.silent': '靜音',
    'focus.sound.white': '白噪音',
    'focus.sound.rain': '雨聲',
    'focus.sound.wave': '海浪',
    'focus.sound.forest': '森林',
    'focus.sound.fire': '篝火',
    ...
    'settings.login': '使用 Google 登入',
    'settings.login.apple': '使用 Apple 登入',
    'settings.logout': '登出帳號',
    'settings.login.success': '登入成功！',
    'settings.login.fail': '登入失敗，請再試一次',
    'settings.logout.success': '已登出',
    'settings.account.title': '帳號',
    'settings.delete_account': '刪除帳號',
    'settings.delete_account.confirm': '確定要刪除帳號嗎？\n此操作將永久刪除你的雲端存檔，且無法復原。',
    'settings.delete_account.btn': '確認刪除',
    'settings.delete_account.fail': '刪除失敗，請再試一次',
    'settings.cancel': '取消',
    ...
    'bank.noSteps': '沒有步數資料可兌換！',
    'bank.notEnoughSteps': '步數不足以兌換任何能量石！',
    // 稀有度
    'rarity.F': 'F',
    'rarity.R': 'R',
    'rarity.SR': 'SR',
    ...
    'toast.petLocked': '前往扭蛋機解鎖！',
    'toast.petSelected': '選擇了 {name}！',
    'toast.useCandy': '使用愛心糖！+10心情 😄',
    'toast.useXpboost': '使用成長藥！+20 EXP ⭐',
    'toast.buySuccess': '購買成功：{name} ×1',
    'toast.ticketAdded': '🎫 {name} 已加入背包！',
    'toast.slotsFull': '所有巢位已滿！',
    'toast.adGachaUsed': '今日廣告扭蛋已使用！',
    'toast.adSpecialGachaUsed': '今日特殊卡池廣告已使用！',
    'toast.petAddedToNest': '✅ {name} 加入巢位！',
    ...
    'quest.d10.name': '專注達人', 'quest.d10.desc': '完成三次專注計時',
    ...
    'quest.a10.name': '幸運降臨', 'quest.a10.desc': '抽中第一隻 SR 寵物',
    'quest.a11.name': '小富翁',   'quest.a11.desc': '累積花費 1000 能量石',
    'quest.a12.name': '大富翁',   'quest.a12.desc': '累積花費 5000 能量石',
    'quest.a13.name': '初次專注', 'quest.a13.desc': '第一次完成專注計時',
    'quest.a14.name': '專注新手', 'quest.a14.desc': '累積完成 10 次專注',
    'quest.a15.name': '專注老手', 'quest.a15.desc': '累積完成 50 次專注',
    'quest.a16.name': '專注大師', 'quest.a16.desc': '累積完成 100 次專注',
    'quest.a17.name': '長時專注', 'quest.a17.desc': '完成一次 45 分鐘以上的專注',
    ...
    'quest.w4.name': '本週專注', 'quest.w4.desc': '本週完成 5 次專注計時',
    'quest.w5.name': '專注馬拉松', 'quest.w5.desc': '本週累積專注時間達 3 小時',
  },
  ...
  'en': {
    ...
    'focus.penalty': 'Pixel Gems -100',
    'focus.home': 'Return Home',
    'focus.restart': 'Try Again',
    'focus.sound': 'Background Sound',
    'focus.sound.silent': 'Silent',
    'focus.sound.white': 'White Noise',
    'focus.sound.rain': 'Rain',
    'focus.sound.wave': 'Ocean',
    'focus.sound.forest': 'Forest',
    'focus.sound.fire': 'Campfire',
    ...
    'bag.pet.title': '🐾 Pets',
    'pet.pick.add': 'Add to Nest',
    'pet.pick.slots_full': 'Nest Full',
    'bag.food': 'Food',
    'bag.drink': 'Drinks',
    'bag.item': 'Items',
    'bag.pet': 'Pets',
    ...
    'settings.login.apple': 'Sign in with Apple',
    'settings.logout': 'Sign Out',
    'settings.login.success': 'Signed in!',
    'settings.login.fail': 'Sign in failed, please try again',
    'settings.logout.success': 'Signed out',
    'settings.account.title': 'Account',
    'settings.delete_account': 'Delete Account',
    'settings.delete_account.confirm': 'Are you sure you want to delete your account?\nThis will permanently delete your cloud save and cannot be undone.',
    'settings.delete_account.btn': 'Confirm Delete',
    'settings.delete_account.fail': 'Delete failed, please try again',
    ...
    'bank.noSteps': 'No step data available to exchange!',
    'bank.notEnoughSteps': 'Not enough steps to exchange for any gems!',
    // Rarity
    'rarity.F': 'F',
    'rarity.R': 'R',
    'rarity.SR': 'SR',
    ...
    'toast.petLocked': 'Head to the gacha machine to unlock!',
    'toast.petSelected': 'Selected {name}!',
    'toast.useCandy': 'Used Love Candy! +10 Mood 😄',
    'toast.useXpboost': 'Used Growth Potion! +20 EXP ⭐',
    'toast.buySuccess': 'Purchased: {name} ×1',
    ...
    'toast.petAddedToNest': '✅ {name} added to nest!',
    ...
    'quest.d10.name': 'Focus Expert',    'quest.d10.desc': 'Complete three focus sessions',
    ...
    'quest.a10.name': 'Lucky Draw',      'quest.a10.desc': 'Pull your first SR pet',
    ...
    'quest.a13.name': 'First Focus',     'quest.a13.desc': 'Complete your first focus session',
    'quest.a14.name': 'Focus Beginner',  'quest.a14.desc': 'Complete 10 focus sessions total',
    'quest.a15.name': 'Focus Veteran',   'quest.a15.desc': 'Complete 50 focus sessions total',
    'quest.a16.name': 'Focus Master',    'quest.a16.desc': 'Complete 100 focus sessions total',
    'quest.a17.name': 'Long Focus',      'quest.a17.desc': 'Complete a focus session of 45+ minutes',
    ...
    'quest.w4.name': 'Weekly Focus',     'quest.w4.desc': 'Complete 5 focus sessions this week',
    'quest.w5.name': 'Focus Marathon',   'quest.w5.desc': 'Accumulate 3 hours of focus time this week',
  },
